...
void _fm0_g_and_1_(loop_t &h)
{
    ...
    {
        if (Flag) { p_Rslt = nullptr; h.avflag += 1; } // to access violation
    }
}
...
void _fm0_loop_2_(bool all, loop_t &h)
{
    ...
    while (u < w)
    {
        ...
        if (g == 0) { _fm0_g_and_0_(h); h.g0 += 1; } else { _fm0_g_and_1_(h); h.g1 += 1; }
...
void _fm0_()
{
    ...
    {
        loop_t h = { .z1 = z_none, .z2 = z_none, .g0 = z_none, .g1 = z_none, .avflag = z_none };
